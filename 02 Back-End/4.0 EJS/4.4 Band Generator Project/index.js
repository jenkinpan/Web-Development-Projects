...
app.post("/submit", (req, res) => {
  const randomNumOfAdj = Math.floor(Math.random() * adj.length);
  const randomNumOfNoun = Math.floor(Math.random() * noun.length);

  const randomBandName = `${adj[randomNumOfAdj]} ${noun[randomNumOfNoun]}`;
  res.render("index.ejs", { randomBandName: randomBandName });
